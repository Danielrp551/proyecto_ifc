...
export default function ClientsManagement() {
    ...
    const [filtros, setFiltros] = useState({ estado_cliente: "vacio", bound: "vacio",search: "",dateRange: { from: null, to: null } }); // Filtros de búsqueda
    ...
    useEffect(() => {
        const fetchClients = async () => {
            ...
            try {
                ...
                const response = await fetch(
                    `api/clients?page=${page + 1}&pageSize=${pageSize}${estado}${bound}${search}${dateRange}`
                );
        ...
        fetchClients();
    }, [page, pageSize,refresh, filtros.estado_cliente, filtros.bound,filtros.dateRange]);
                ...
                <>      
                    ...
                    >
                        <Box className="flex flex-wrap gap-2 mx-0 p-0">
                            ...
                            <FormControl variant="outlined" size="small" sx={{ minWidth: 145 }}>
                        ...
                        <Box className="flex flex-wrap gap-2 mt-2 mb-2 mx-0 p-0">
                            <DateFilterv2 onDateChange={handleDateChange} reset={resetFilters} 
                                setStartDate={setStartDate} setEndDate={setEndDate} setSelectedPreset={setSelectedPreset}
                                startDate={startDate} endDate={endDate} selectedPreset={selectedPreset}  
                            />
